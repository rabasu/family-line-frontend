...
export const grades = {
  ...
  national_big8: { name: "八大競走", rank: 1, description: "国営競馬八大競走(~1954/09/24)" },
  national_grade: { name: "重賞", rank: 2, description: "国営競馬重賞競走(~1954/09/24)" },
  national_grandjump: { name: "大障害競走", rank: 1, description: "国営競馬中山大障害(~1954/09/24)" },
  national_jump: { name: "障害重賞", rank: 2, description: "国営競馬障害重賞競走(~1954/09/24)" },
  jrs_big8: { name: "八大競走", rank: 1, description: "日本競馬会八大競走(~1948/09/10)" },
  jrs_grade: { name: "重賞", rank: 2, description: "日本競馬会重賞競走(~1948/09/10)" },
  jrs_grandjump: { name: "大障害競走", rank: 1, description: "日本競馬会中山大障害(~1948/09/10)" },
  jrs_jump: { name: "障害重賞", rank: 2, description: "日本競馬会障害重賞競走(~1948/09/10)" },
