...
export const grades = {
  ...
  jra_ungraded: new Grade('重賞', 4, 'JRA 格付けなし重賞'),
  ...
  local_old_big: new Grade('地方重賞', 5, '地方主要重賞競走(~1997/3/31)'),
  local_old_grade: new Grade('地方重賞', 6, '地方重賞競走(~1997/3/31)'),
  jra_jg1: new Grade('J・GI', 1, 'JRA 障害GI'),
  jra_jg2: new Grade('J・GII', 2, 'JRA 障害GII'),
  jra_jg3: new Grade('J・GIII', 3, 'JRA 障害GIII'),
  jra_big8: new Grade('八大競走', 5, 'JRA八大競走(~1983/12/31)'),
  jra_big10: new Grade('旧GI級競走', 5, 'JRA宝塚記念・エリザベス女王杯・ジャパンカップ(1976~1983/12/31)'),
  jra_grade: new Grade('重賞', 6, 'JRA重賞競走(~1983/12/31)'),
  jra_grandjump: new Grade('大障害競走', 5, 'JRA中山大障害(~1998/12/31)'),
  jra_jump: new Grade('障害重賞', 6, 'JRA障害重賞競走(~1998/12/31)'),
  ...
  empire_2mile: new Grade('連合競走', 5, '各種連合競走・横浜特別(~1937/08/06)'),
  empire_cup: new Grade('帝室御賞典', 5, '統一前の帝室御賞典(~1937/08/06)'),
